...
const WorksSample = () => {
  return (
    <div style={{ padding:"60px 0" ,overflow:"hidden",width:"100%",background:"white",display:"grid",placeItems:'center'}}  >
        <Info data-aos="fade-left" >
            <Title>PROJECTS</Title>
            <Desc><span>See how our products look like in real examples!</span> <span style={{height:'3px', width:"20%",background:"#ffc107"}} ></span> </Desc>
        </Info>
      <ImageList
